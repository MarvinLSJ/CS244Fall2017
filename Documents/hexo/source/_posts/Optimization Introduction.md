...
2. $f\subset C^1$, $f$ is convex over $\Omega$ if and only if $\forall x,y \ f(y) \geq f(x) + f^\prime(x)(y-x)$
      ...
      [![convex](https://github.com/MarvinLSJ/CS268_Optimization/blob/master/notes/images/image-20181029110014771.png?raw=true)](https://github.com/MarvinLSJ/CS268_Optimization/blob/master/notes/images/image-20181029110014771.png?raw=true)
...
Subjected to application level, these methods can be categorized by **input** information:

$C^0$ input: Only know the $f(x)$ itself;
